...
print("=== BEAUTYGROUP BOT STARTED ===", flush=True)
...
# secrets blijven zoals je oude bot
ENV_USERNAME = "BSKY_USERNAME_BG"
ENV_PASSWORD = "BSKY_PASSWORD_BG"
